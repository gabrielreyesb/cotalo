...
class PapersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create paper" do
    assert_difference("Paper.count") do
      post papers_url, params: { paper: { description: @paper.description, size: @paper.size, weight: @paper.weight } }
    end
  ...
  test "should update paper" do
    patch paper_url(@paper), params: { paper: { description: @paper.description, size: @paper.size, weight: @paper.weight } }
