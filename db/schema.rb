...
ActiveRecord::Schema[7.1].define(version: 2025_02_10_182100) do
  create_table "app_settings", force: :cascade do |t|
    ...
    t.index ["user_id", "key"], name: "index_app_settings_on_user_id_and_key", unique: true
    t.index ["user_id"], name: "index_app_settings_on_user_id"
  end
